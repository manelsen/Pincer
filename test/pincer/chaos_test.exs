defmodule Pincer.ChaosTest do
  ...
  test "ULTRA STRESS TEST: 100,000 operations" do
    ...
    Logger.info("📊 Bombardeio concluído em #{duration}ms. (#{Float.round(n / (duration / 1000), 2)} ops/sec)")
    ...
    assert read_duration < 50_000 # Deve ler 100 mensagens em menos de 50ms (geralmente < 1ms em ETS)
