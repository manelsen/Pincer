defmodule Pincer.Core.PortsContractTest do
  ...
  test "capability discovery module declares discovery port behaviour" do
    ...
    assert Pincer.Core.Ports.CapabilityDiscovery in behaviours
  end
end
